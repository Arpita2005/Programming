	...
	public int add_book()
  {
       // long j;
		...
		{  
			...
			accession_number=second.nextLong();
            ...
            {
                j=return_date-30;
                System.out.println("Return date should be :"+j+" of next month");
			    System.out.println("\n====================:::::::::::::::===================\n");
            }
            else if(return_date<30)
            {
                System.out.println("Return date should be :"+return_date+" of "+book_issue_month);
			    System.out.println("\n====================:::::::::::::::===================\n");
            }
    ...
    public void view(int number)
   {
    ...
    public void list(int number)
    {
        ...
        for(int i=0;i<number;i++)
        {
            System.out.println("|Book Details of "+(i+1) +" book is : |");
                ...
                {
                    System.out.println(((CharSequence) e).charAt(i));
                }
        }
    ...
    public void acc_num(int number)
    {
        ...
        for(int i=0;i<number;i++)
       {
             if(bd[i].accession_number==ac_num)//&&(!bd[i+1].accession_number.equalsIgnoreCase(ac_num)))
             {
    ...
    public void borrow(int number)
    {
        ...
        System.out.println("Enter the Accession Number :\n");
        a_num=input1.nextLong();
        for(int i=0;i<number;i++)
        {
            if((bd[i].book_title.equalsIgnoreCase(a_name))&&(bd[i].accession_number==a_num))
            {
