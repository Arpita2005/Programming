...
#include <stdio.h>
//#include <conio.h>
// Program is running successfully and logically...Check 
int main()
{
    ...
    do
    {
        ...
        fflush(stdin); // Function added
        scanf("%c", &decide); // You can also write decide=getche();  and add header file  conio.h
        // conditional statements added
        if(decide>=97 && decide<=122)
        	decide = decide-32 ;
       
    } while(decide!='N'); //  decide !='N'  instead of  decide   added
